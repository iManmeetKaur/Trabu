	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			...
			<!--/down-->
						...
						<!--Main Body-->
						<div class="card" style="width:200px; height:230px; background-color:#231f20; float:left;">
							  <a href="add_bus.php"><img src="images/add.png" style="width:100%; height:170px;"></a>
						...
						<div class="card" style="width:200px; height:230px; background-color:#231f20; float:left;">
							   <a href="delete.php"><img src="images/delete.png" style="width:100%; height:170px;"></a>
							  <div class="container_card" style="font-size:18px;color:#ffffff;">
						...
						<div class="card" style="width:200px; height:230px; background-color:#231f20; float:left;">
							   <a href="update_bus.php"><img src="images/update.png" style="width:100%; height:170px;"></a>
							  <div class="container_card" style="font-size:18px;color:#ffffff;">
						...
						<div class="card" style="width:200px; height:230px; background-color:#231f20; float:left;">
							   <a href="view_bus.php"><img src="images/view.png" style="width:100%; height:170px;"></a>
							  <div class="container_card" style="font-size:18px;color:#ffffff;">
